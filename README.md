...
[Ссылка на ДЗ-1](https://github.com/netology-code/py-homeworks-db/tree/SQLPY-76/01-introduction)

### Задание 1 (практика): / Task 1
...
Необходимо установить PostgreSQL и DBeaver Community на свой ПК.


## Домашнее задание к лекции «Работа с SQL. Создание БД» 
[Ссылка на ДЗ-2](https://github.com/netology-code/py-homeworks-db/tree/SQLPY-76/02-creation)
...
[Ссылка на ДЗ-3](https://github.com/netology-code/py-homeworks-db/tree/SQLPY-76/04-dml)
